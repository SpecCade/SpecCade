...
| `preview` | Preview/thumbnail | Reserved (not generated by current backends) |
| `metadata` | Generation metadata | Reserved (use `${asset_id}.report.json` written next to the spec) |
