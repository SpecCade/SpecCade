# Game Music Genre Kits — Master Inventory (Draft)
...
- What a genre kit includes
- Standard role taxonomy
- Kit requirements (quality, licensing, variation)
- Master inventory (game-focused kits)
...
#### Kit: **Chiptune 16-bit / Amiga Tracker Retro**
...
#### Kit: **DnB / Breakbeat (original breaks, not ripped)**
...
#### Kit: **Fantasy Cinematic (Synth-Orchestral, stylized)**
...
#### Kit: **Military / March / Strategy (stylized)**
...
#### Kit: **Celtic / Medieval Folk (stylized)**
...
#### Kit: **Afrobeat / Afrofusion (stylized)**
...
#### Kit: **Dub / Reggae / Caribbean (stylized)**
...
#### Kit: **Middle Eastern / Desert (stylized)**
...
## 6) Quick coverage map (game modes → kits)
...
1) Decide the initial “v1 pack” subset (e.g., 6–8 kits).
2) For each kit:
