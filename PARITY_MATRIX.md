...
| Key | Required | Type | Constraints | Default | Notes |
|-----|----------|------|-------------|---------|-------|
...
| `pitch_envelope` | No | `dict` | - | - | Pitch envelope (not fully implemented) |
...
| `input_armature` | Yes | `str` | Path | - | Input GLB with armature |
...
| `clean_curves` | No | `bool` | - | `True` | Clean redundant keyframes |
| `remove_ik_bones` | No | `bool` | - | `True` | Remove IK control bones |
| `remove_constraints` | No | `bool` | - | `True` | Remove constraints |
