...
| `texture.material_v1` | `texture` | `speccade-backend-texture` | 1 | `png` | Implemented | PBR material maps via multiple outputs |
| `texture.normal_v1` | `texture` | `speccade-backend-texture` | 1 | `png` | Implemented | Normal map generator |
| `texture.packed_v1` | `texture` | `speccade-backend-texture` | 1 | `png` (`outputs[].kind = packed`) | Implemented | Channel packing per RFC-0002 |
