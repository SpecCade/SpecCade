...
use super::super::validation::{extract_float, validate_enum, validate_non_empty, validate_positive_int, validate_unit_range};
...
fn register_texture_node_functions(builder: &mut GlobalsBuilder) {
    ...
    fn noise_node<'v>(
        ...
        validate_non_empty(id, "noise_node", "id")
        ...
        noise_dict.insert_hashed(
            hashed_key(heap, "scale"),
            heap.alloc(scale).to_value(),
        );
        noise_dict.insert_hashed(
            hashed_key(heap, "octaves"),
            heap.alloc(octaves).to_value(),
        );
        noise_dict.insert_hashed(
        ...
        dict.insert_hashed(
            ...
            heap.alloc(noise_dict).to_value(),
        );
    ...
    fn gradient_node<'v>(
        ...
        validate_non_empty(id, "gradient_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        ...
        dict.insert_hashed(
            hashed_key(heap, "start"),
            heap.alloc(start).to_value(),
        );
        dict.insert_hashed(
            hashed_key(heap, "end"),
            heap.alloc(end).to_value(),
        );

        // Add optional radial gradient parameters
        if !center.is_none() {
            // Extract list of 2 floats for center
            let list = center.iterate(heap).map_err(|e| anyhow::anyhow!(
            ...
            let center_list = heap.alloc(AllocList(vec![
                items[0],
                items[1],
            ]));
            dict.insert_hashed(
        ...
        if !inner.is_none() {
            let inner_val = extract_float(inner, "gradient_node", "inner")
                .map_err(|e| anyhow::anyhow!(e))?;
            dict.insert_hashed(
                hashed_key(heap, "inner"),
                heap.alloc(inner_val).to_value(),
            );
        }

        if !outer.is_none() {
            let outer_val = extract_float(outer, "gradient_node", "outer")
                .map_err(|e| anyhow::anyhow!(e))?;
            dict.insert_hashed(
                hashed_key(heap, "outer"),
                heap.alloc(outer_val).to_value(),
            );
        }
    ...
    fn constant_node<'v>(
        ...
        validate_non_empty(id, "constant_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        ...
        dict.insert_hashed(
            hashed_key(heap, "value"),
            heap.alloc(value).to_value(),
        );
    ...
    fn threshold_node<'v>(
        ...
        validate_non_empty(id, "threshold_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(input, "threshold_node", "input")
            .map_err(|e| anyhow::anyhow!(e))?;
        ...
        dict.insert_hashed(
            hashed_key(heap, "input"),
            heap.alloc_str(input).to_value(),
        );
        dict.insert_hashed(
    ...
    fn invert_node<'v>(
        ...
        validate_non_empty(id, "invert_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(input, "invert_node", "input")
            .map_err(|e| anyhow::anyhow!(e))?;
    ...
    fn color_ramp_node<'v>(
        ...
        validate_non_empty(id, "color_ramp_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(input, "color_ramp_node", "input")
            .map_err(|e| anyhow::anyhow!(e))?;
    ...
    fn add_node<'v>(
        ...
        validate_non_empty(id, "add_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(a, "add_node", "a")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(b, "add_node", "b")
            .map_err(|e| anyhow::anyhow!(e))?;
    ...
    fn multiply_node<'v>(
        ...
        validate_non_empty(id, "multiply_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(a, "multiply_node", "a")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(b, "multiply_node", "b")
            .map_err(|e| anyhow::anyhow!(e))?;
    ...
    fn lerp_node<'v>(
        ...
        validate_non_empty(id, "lerp_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(a, "lerp_node", "a")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(b, "lerp_node", "b")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(t, "lerp_node", "t")
            .map_err(|e| anyhow::anyhow!(e))?;
    ...
    fn clamp_node<'v>(
        ...
        validate_non_empty(id, "clamp_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(input, "clamp_node", "input")
            .map_err(|e| anyhow::anyhow!(e))?;
        if min > max {
            return Err(anyhow::anyhow!(
        ...
        dict.insert_hashed(
            hashed_key(heap, "min"),
            heap.alloc(min).to_value(),
        );
        dict.insert_hashed(
            hashed_key(heap, "max"),
            heap.alloc(max).to_value(),
        );
    ...
    fn stripes_node<'v>(
        ...
        validate_non_empty(id, "stripes_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        ...
        validate_positive_int(stripe_width as i64, "stripes_node", "stripe_width")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_unit_range(color1, "stripes_node", "color1")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_unit_range(color2, "stripes_node", "color2")
            .map_err(|e| anyhow::anyhow!(e))?;
        ...
        dict.insert_hashed(
            hashed_key(heap, "color1"),
            heap.alloc(color1).to_value(),
        );
        dict.insert_hashed(
            hashed_key(heap, "color2"),
            heap.alloc(color2).to_value(),
        );
    ...
    fn checkerboard_node<'v>(
        ...
        validate_non_empty(id, "checkerboard_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
    ...
    fn grayscale_node<'v>(
        ...
        validate_non_empty(id, "grayscale_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(input, "grayscale_node", "input")
            .map_err(|e| anyhow::anyhow!(e))?;
    ...
    fn palette_node<'v>(
        ...
        validate_non_empty(id, "palette_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(input, "palette_node", "input")
            .map_err(|e| anyhow::anyhow!(e))?;
        ...
        let palette_values: Vec<Value> = palette.items.iter()
            .map(|c| heap.alloc_str(c).to_value())
            .collect();
        let palette_list = heap.alloc(AllocList(palette_values));
        dict.insert_hashed(
            hashed_key(heap, "palette"),
            palette_list,
        );
    ...
    fn compose_rgba_node<'v>(
        ...
        validate_non_empty(id, "compose_rgba_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(r, "compose_rgba_node", "r")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(g, "compose_rgba_node", "g")
            .map_err(|e| anyhow::anyhow!(e))?;
        validate_non_empty(b, "compose_rgba_node", "b")
            .map_err(|e| anyhow::anyhow!(e))?;
        ...
        dict.insert_hashed(
            hashed_key(heap, "r"),
            heap.alloc_str(r).to_value(),
        );
        dict.insert_hashed(
            hashed_key(heap, "g"),
            heap.alloc_str(g).to_value(),
        );
        dict.insert_hashed(
            hashed_key(heap, "b"),
            heap.alloc_str(b).to_value(),
        ...
        if !a.is_none() {
            ...
            validate_non_empty(a_str, "compose_rgba_node", "a")
                .map_err(|e| anyhow::anyhow!(e))?;
            dict.insert_hashed(
                hashed_key(heap, "a"),
                heap.alloc_str(a_str).to_value(),
            );
        }
    ...
    fn normal_from_height_node<'v>(
        ...
        validate_non_empty(id, "normal_from_height_node", "id")
            .map_err(|e| anyhow::anyhow!(e))?;
