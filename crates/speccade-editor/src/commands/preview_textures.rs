...
const GOLDEN_TEXTURES: &[GoldenTextureDef] = &[
    GoldenTextureDef {
        ...
        kind: "matcap",
        filename: "golden:matcap_toon_basic.star",
        source: include_str!("../../../../golden/starlark/texture_matcap.star"),
    },
    GoldenTextureDef {
        id: "tex_noise_mask",
        label: "2D: Noise Mask",
        kind: "2d",
        filename: "golden:tex_noise_mask.star",
        source: include_str!("../../../../golden/starlark/texture_noise.star"),
    },
    GoldenTextureDef {
        id: "tex_patterns",
        label: "2D: Patterns",
        kind: "2d",
        filename: "golden:tex_patterns.star",
        source: include_str!("../../../../golden/starlark/texture_patterns.star"),
    },
    GoldenTextureDef {
        id: "tex_normalmap",
        label: "2D: Normal Map",
        kind: "2d",
        filename: "golden:tex_normalmap.star",
        source: include_str!("../../../../golden/starlark/texture_normalmap.star"),
    },
    GoldenTextureDef {
        id: "tex_colored",
        label: "2D: Colored",
        kind: "2d",
        filename: "golden:tex_colored.star",
        source: include_str!("../../../../golden/starlark/texture_colored.star"),
    },
    GoldenTextureDef {
        id: "tex_material_preset",
        label: "2D: Material Preset (Albedo)",
        kind: "2d",
        filename: "golden:tex_material_preset.star",
        source: include_str!("../../../../golden/starlark/texture_material_preset.star"),
    },
];
